"""
Django settings for my_kanban2 project.
...
SECRET_KEY = 'django-insecure-zlcn9c7cd#1nw$39lazlr=lh@(egpit#^)73*36o&%&hmi4kl%'
...
ROOT_URLCONF = 'my_kanban2.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'my_kanban2' / 'templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'my_kanban2.wsgi.application'
